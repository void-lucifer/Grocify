        ...
        <div className="register-page">
            <form className="form-fill">
                ...
                <div className="form-group">
                    <input type="text" name="name" className="" value={data.name} placeholder="Enter Name" onChange={handleInput} />
                </div>
                <div className="form-group">
                    <input type="email" name="email" className="" value={data.email} placeholder="Enter email" onChange={handleInput} />
                </div>
                <div className="form-group">
                    <input type="password" name="password" className="" value={data.password} placeholder="Enter Password" onChange={handleInput} />
                </div>
                <div className="account-present">
                    <h5>Already have an account?&nbsp; <span onClick={() => { navigate('/login') }}>Login</span></h5>
                </div>
                <div className="grocify-button-container login-register-btn" onClick={handleRegister}>
