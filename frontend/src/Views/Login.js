            ...
            <div className="login-page">
                <form className="form-fill">
                    ...
                    <div className="form-group">
                        <input type="email" name="email" className="" value={data.email} placeholder="Email" onChange={handleInput} />
                    </div>
                    <div className="form-group">
                        <input type="password" name="password" className="" value={data.password} placeholder="Password" onChange={handleInput} />
                    </div>
                    <div className="account-present"><h5>Don't have an account? <span onClick={() => { navigate('/register') }}> Register</span></h5></div>
                    <div className="grocify-button-container login-register-btn" onClick={handleLogin}>
